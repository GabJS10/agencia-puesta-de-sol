...
export interface ApiGalleryImageGalleryImage
  ...
  info: {
    description: 'Im\u00E1genes de la galer\u00EDa del sitio';
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    estadistica: Schema.Attribute.Component<'estadistica.estadistica', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    Footer: Schema.Attribute.Component<'home-hero.footer', false> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    HeroTours: Schema.Attribute.Component<'home-hero.home-hero', true> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    HomeReviews: Schema.Attribute.Component<'home-hero.reviews', true> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    HomeTours: Schema.Attribute.Component<'home-hero.home-tours', true> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiPlanPlan extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    tags: Schema.Attribute.Component<'planes.tags', true> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
